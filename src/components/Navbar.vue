<template>
    ...
    <div class="flex items-center gap-10" >
      ...
      <a class="text-white font-medium " href="#trick-or-treat">Trick or Treat</a>
      <button class="px-8 py-3 rounded-full text-white text-lg font-bold bg-secondary">Donate</button>
    </div>
  </nav>
</template>